      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl mx-4">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Fatura Durumu</label>
              <select
                value={form.status}
              ...
              <div className="flex gap-1 mt-1">
                {PAYMENT_DAYS.map(d => (
                  <button type="button" key={d} onClick={() => setDueDays(d)}
                    className="text-xs px-2 py-0.5 bg-gray-100 hover:bg-blue-100 text-gray-600 hover:text-blue-700 rounded transition">
                    {d}g
                  </button>
                ))}
              </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <h3 className="font-semibold text-gray-800">Kalemler</h3>
                    ...
                    <tr key={i} className="border-t border-gray-100">
                      ...
                      <td className="px-3 py-2">
                        <select
                          ...
                          className="w-full text-xs border border-gray-200 rounded px-1 py-1 focus:ring-1 focus:ring-blue-400"
                        >
                      ...
                      <td className="px-3 py-2">
                        <input
                          ...
                          className="w-full text-right border border-gray-200 rounded px-1 py-1 focus:ring-1 focus:ring-blue-400"
                        />
                      </td>
                      <td className="px-3 py-2">
                        <input
            ...
            <div className="space-y-2 bg-gray-50 rounded-xl p-4">
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <input
                  ...
                  className="w-24 text-right border border-gray-300 rounded px-2 py-1 text-sm ml-auto"
                />
              </div>
              <div className="flex items-center gap-2 text-sm">
                <span className="text-gray-500 w-28">KDV (%)</span>
                <select
                  value={form.tax_rate}
                  onChange={e => setForm(f => ({ ...f, tax_rate: e.target.value }))}
                  className="w-24 border border-gray-300 rounded px-2 py-1 text-sm ml-auto"
                >
