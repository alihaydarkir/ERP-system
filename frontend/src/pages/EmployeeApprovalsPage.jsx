...
export default function EmployeeApprovalsPage() {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-2">Çalışan Onayları</h1>
        <p className="text-gray-600">Şirketinize katılmak isteyen kullanıcıları yönetin</p>
      </div>
          ...
          <div className="p-6">
            {pendingUsers.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 text-lg">Bekleyen istek yok</p>
              </div>
            ) : (
